%{
    UPDATE: This was used to vary the initial volume of water as interpolation would not work.

    DATE: 12/10/2024
    TIME STAMP: 9:35 PM MT
%}
...
function const = getConst()
    ...
    const.Vi_water = 0.001; % Initial water volume (m^3)                  % THIS VALUE CHANGED FROM (0.0001 - 0.01) m^3
