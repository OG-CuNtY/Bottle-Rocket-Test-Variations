%{
    UPDATE: CODE BLOCK WORKs, HOWEVER,  PREDICTION ARE WRONG. INITIAL LAUNCH
...
xlim([0 95]);
ylim([0 max(state(:, 3))+5]);
legend("Verification Data", "Current Data", Location="northeast");
grid on;
grid minor;
hold off;
snapnow;
